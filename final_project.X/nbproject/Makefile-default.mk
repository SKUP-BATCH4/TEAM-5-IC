...
SOURCEFILES_QUOTED_IF_SPACED=team5_IC.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/team5_IC.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/team5_IC.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/team5_IC.p1

# Source Files
SOURCEFILES=team5_IC.c
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/team5_IC.p1: team5_IC.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/team5_IC.p1.d 
	@${RM} ${OBJECTDIR}/team5_IC.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c90 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/team5_IC.p1 team5_IC.c 
	@-${MV} ${OBJECTDIR}/team5_IC.d ${OBJECTDIR}/team5_IC.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/team5_IC.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
